    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Singularity Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and singularity: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Singularity Core"), this);
    aboutAction->setStatusTip(tr("Show information about Singularity Core"));
    ...
    openAction->setStatusTip(tr("Open a singularity: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Singularity Core help message to get a list with possible Singularity command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Singularity Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Singularity Core"); // default title
