...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Singularity Core"),
     ...
     * override -datadir in the singularity.conf file in the default data directory
     * (to be consistent with singularityd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
