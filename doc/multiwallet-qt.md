...
Only requiring some minor changes is singularity.cpp.
...
Changes to singularity.cpp
----------------------
singularity.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
