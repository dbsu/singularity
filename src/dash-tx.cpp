...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Singularity Core singularity-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  singularity-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded singularity transaction") + "\n" +
              "  singularity-tx [options] -create [commands]   " + _("Create hex-encoded singularity transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded singularity transaction
