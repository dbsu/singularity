    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Singularity Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Singularity Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Singularity Core is shutting down...") + "<br /><br />" +
