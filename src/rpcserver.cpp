...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "singularity",               "masternode",             &masternode,             true,      true,       false },
    { "singularity",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "singularity",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "singularity",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "singularity",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "singularity",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "singularity",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "singularity",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "singularity",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use singularityd, or the -server option to singularity-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> singularity-cli " + methodname + " " + args + "\n";
}
